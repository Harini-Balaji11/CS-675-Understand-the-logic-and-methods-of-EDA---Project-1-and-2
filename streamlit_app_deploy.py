...
def main():
    ...
    <div style='text-align: center; color: #666;'>
        <p>Built with Streamlit | Data Science Project by Harini Balaji</p>
        <p><strong>Portfolio Project:</strong> Telco Customer Churn Analysis</p>
        <p><a href="https://github.com/Harini-Balaji11/CS-675-Understand-the-logic-and-methods-of-EDA---Project-1-and-2">View on GitHub</a></p>
    </div>
    """, unsafe_allow_html=True)
